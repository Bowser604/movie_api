...
let topMovies = [
  { 
    'Title':'Snatch',
    'Description':'llegal boxing promoter Turkish (Jason Statham) convinces gangster Brick Top (Alan Ford) to offer bets on bare-knuckle boxer Mickey (Brad Pitt) at his bookie business. When Mickey does not throw his first fight as agreed, an infuriated Brick Top demands another match.',
    'Genre':{
      'Name':'Crime/Comedy',
      'year':'2000',
  }, 
  ...
  {
    Title:'Sicario', 
    'Description':'After rising through the ranks of her male-dominated profession, idealistic FBI agent Kate Macer (Emily Blunt) receives a top assignment. Recruited by mysterious government official Matt Graver (Josh Brolin), Kate joins a task force for the escalating war against drugs.',
    'Genre':{
      'Name':'Action/Crime',
      'year':'2015',
  }, 
  ...
  { 
    ...
    'Description':'Eddy (Nick Moran) convinces three friends to pool funds for a high-stakes poker game against local crime boss Hatchet Harry (P.H. Moriarty). Harry cheats and Eddy loses, giving him a week to pay back 500,000 pounds or hand over his fathers pub.',
    'Genre':{
      'Name':'Comedy/Crime',
      'year':'1998',
  }, 
  ...
  { 
    ...
    'Description':'Kenshin reunites with a former master to ready for battle against Makoto Shishio who has formed an army fleet to overthrow the Meiji government and destroy his enemies.',
    'Genre':{
...
},
  {
    ...
    'Description':'Cursed with immortality, a highly skilled samurai in feudal Japan promises to help a young woman avenge the death of her parents. Their mission leads them into a bloody battle with a ruthless warrior and his band of master swordsmen.',
    'Genre':{
      'Name':'Action/Crime',
      'year':'2017',
  }, 
...
//READ
app.get('/', (req, res) => {
  res.send('My to  my top 10 movies list!');
});
